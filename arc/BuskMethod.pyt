"""
Busk Method Toolbox for Stratigraphic Height Calculation
...
class Toolbox(object):
    def __init__(self):
        """Define the toolbox"""
        self.label = "Busk Method Toolbox"
        self.alias = "busk"
        self.tools = [BuskDownplungeView]


class BuskDownplungeView(object):
    def __init__(self):
        """Define the tool"""
        self.label = "Busk Downplunge View"
    ...
    def execute(self, parameters, messages):
        ...
        arcpy.AddMessage("=" * 60)
        arcpy.AddMessage("Busk Method - Downplunge View Generation")
        arcpy.AddMessage("=" * 60)
